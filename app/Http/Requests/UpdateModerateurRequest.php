...
class UpdateModerateurRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'nom' => 'required',
            'prenom' => 'required',
            'telephone' => ['required', 'integer', Rule::unique('admins')->ignore($this->route()->parameter('moderateur'))],
            'adresse' => 'required|string|max:20',
            'email' => ['required', 'email', 'max:50', Rule::unique('admins')->ignore($this->route()->parameter('moderateur'))],

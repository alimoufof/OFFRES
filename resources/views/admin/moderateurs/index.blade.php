...
@section('header', 'Liste des Modérateurs')
    ...
    <div class="content-body " style="">
        <div class="container-fluid">
            <div class="d-flex align-items-center mb-4 flex-wrap">
                ...
                <div>
                    <a href="{{ route('moderateur.create') }}" class="btn btn-primary me-3"><i
                            class="fas fa-plus me-2"></i>Ajouter un nouveau moderateur</a>
                            ...
                            <tbody>
                                @foreach ($moderateurs as $key => $moderateur)
                                    <tr>
                                        ...
                                        <td>
                                            <img src=" {{asset('storage/'.$moderateur->avatar)}}" width="50" height="50" class="img-fluid rounded-circle" alt="">
                                        </td>
                                        <td>
                                            <div class="action-buttons d-flex justify-content-end">
                                                <a href="{{ route('moderateur.edit', $moderateur) }}"
                                                ...
                                                <form action="{{ route('moderateur.destroy', $moderateur) }}"
                                                    method="POST">

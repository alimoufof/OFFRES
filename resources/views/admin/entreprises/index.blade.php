...
@section('header', 'Liste des entreprises')
    ...
    <div class="content-body " style="">
        <div class="container-fluid">
            <div class="d-flex align-items-center mb-4 flex-wrap">
                <h3 class="me-auto">Liste des entreprises</h3>
                <div>
                    <a href="{{ route('entreprise.create') }}" class="btn btn-primary me-3"><i
                            class="fas fa-plus me-2"></i>Ajouter une nouvelle entreprise</a>
                                ...
                                @else                                   
                                    @foreach ($entreprises as $key => $entreprise)
                                        <tr>
                                            ...
                                            <td>
                                                <img src=" {{asset('storage/'.$entreprise->logo)}}" width="70" height="70" class="img-fluid rounded-circle" alt="">
                                            </td>
                                            {{-- <td>{{ $entreprise->$entreprise->$secteurs }}</td> --}}
                                            <td>
                                                <div class="action-buttons d-flex justify-content-end">
                                                    ...
                                                    <form action="{{ route('entreprise.destroy', $entreprise) }}"
                                                        method="POST">

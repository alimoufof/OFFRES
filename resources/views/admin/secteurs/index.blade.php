...
@section('header', "La liste des secteurs")
    ...
    <div class="content-body " style="">
        <div class="container-fluid">
            <div class="d-flex align-items-center mb-4 flex-wrap">
                <h3 class="me-auto">Liste des secteurs</h3>
                <div>
                    <a href="{{ route('secteur.create') }}" class="btn btn-primary me-3"><i
                            class="fas fa-plus me-2"></i>Ajouter un nouveau secteur</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons d-flex justify-content-end">
                                                <a href="{{ route('secteur.edit', $secteur) }}"
                                                ...
                                                <form action="{{ route('secteur.destroy', $secteur) }}" method="POST">
